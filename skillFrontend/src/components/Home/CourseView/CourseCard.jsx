...
const CourseCard = ({
  ...
  return (
    <div className="min-w-[350px] flex flex-col justify-start items-start bg-[#2c2d30] rounded-2xl border-[1px] border-[#2c2d30] shadow-md shadow-black gap-3">
      <img
        src={img}
        alt={img}
      ...
      <div className="flex flex-col justify-start items-start px-3 text-white/80 w-full gap-1">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="text-[#cbab61] hover:cursor-pointer">
            <FaShare />
          </div>
        </div>
      ...
      <div className="flex flex-col justify-start items-baseline px-3 border-t-[1px] w-full mt-7 ">
      ...
      <div className="flex justify-center items-center w-full ">
        <button className="py-3 bg-[#cbab61] w-[50%] rounded-es-lg text-white hover:bg-[#b99b55]" style={{ WebkitTextStroke: ".2px #000" }}>
          Explore
        </button>
