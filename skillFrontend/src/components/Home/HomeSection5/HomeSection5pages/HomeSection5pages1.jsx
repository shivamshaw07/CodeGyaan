  ...
  return (
    ...
    <div className='w-[50%] bg-[#192A36] h-full flex flex-col justify-start items-start py-24 px-28 gap-8'>
        <div className='flex flex-col justify-start items-start gap-2'>
            <h1 className='text-4xl font-bold text-white'>Guiding You At Every <br /> Step!</h1>
            <p className='text-white font-light'>Our Top Mentors show you the way, <br /> to becoming a thorough professional!</p>
        </div>
    ...
    <div className='absolute w-[300px] h-[300px] bg-[#398DC8] rounded-full flex flex-col justify-center items-center text-white'>
        <div className='text-lg pr-32'>“Your </div><span className='text-4xl font-bold'>Aspiration </span><div className='text-lg font-bold'>is our <span className='text-4xl'>goal”</span></div>
    </div>
</div>
  )
}
