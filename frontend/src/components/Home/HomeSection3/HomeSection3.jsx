        ...
        <div className='w-[85%] mx-auto flex flex-col justify-start items-start'>
            <div className='flex justify-between items-start w-full'>
                ...
                <div className='w-[50%] flex flex-col justify-start items-start gap-5'>
                    <p className='text-white font-light'>The modern CodeGyaan is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.</p>
                    <button className='py-3 px-6 bg-[#cbab61] rounded font-semibold text-white hover:bg-[#b99b55]'>Learn More</button>
                </div>
            </div>
            <div className='w-full flex justify-around items-start py-16'>
                <div className='flex flex-col justify-start items-start gap-4'>
                    ...
                    <div className='h-[5vh] w-full border-dotted border-l-2 ml-7'>
